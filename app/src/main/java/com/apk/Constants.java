...
*/
	...
	public static final File CPU4_CURR_FREQ = new File("/sys/devices/system/cpu/cpu4/cpufreq/scaling_cur_freq");
    public static final File CPU5_CURR_FREQ = new File("/sys/devices/system/cpu/cpu5/cpufreq/scaling_cur_freq");
    public static final File CPU6_CURR_FREQ = new File("/sys/devices/system/cpu/cpu6/cpufreq/scaling_cur_freq");
    public static final File CPU7_CURR_FREQ = new File("/sys/devices/system/cpu/cpu7/cpufreq/scaling_cur_freq");
