...
public class IOHelper {
    ...
    // cpu 当前频率
    public static String getCpu0CruFreq_CPU0(){
        String cpu0CurFreq = "";
        try{
	...
	// cpu 当前频率
    public static String getCpu0CruFreq_CPU1(){
        String cpu0CurFreq = "";
        try{
            cpu0CurFreq = RCommand.readFileContent(Constants.CPU1_CURR_FREQ);
	...
	// cpu 当前频率
    public static String getCpu0CruFreq_CPU2(){
        String cpu0CurFreq = "";
        try{
            cpu0CurFreq = RCommand.readFileContent(Constants.CPU2_CURR_FREQ);
	...
	// cpu 当前频率
    public static String getCpu0CruFreq_CPU3(){
        String cpu0CurFreq = "";
        try{
            cpu0CurFreq = RCommand.readFileContent(Constants.CPU3_CURR_FREQ);
	...
	// cpu 当前频率
    public static String getCpu0CruFreq_CPU4(){
        String cpu0CurFreq = "";
        try{
            cpu0CurFreq = RCommand.readFileContent(Constants.CPU4_CURR_FREQ);
	...
	// cpu 当前频率
    public static String getCpu0CruFreq_CPU5(){
        String cpu0CurFreq = "";
        try{
            cpu0CurFreq = RCommand.readFileContent(Constants.CPU5_CURR_FREQ);
	...
	// cpu 当前频率
    public static String getCpu0CruFreq_CPU6(){
        String cpu0CurFreq = "";
        try{
            cpu0CurFreq = RCommand.readFileContent(Constants.CPU6_CURR_FREQ);
	...
	// cpu 当前频率
    public static String getCpu0CruFreq_CPU7(){
        String cpu0CurFreq = "";
        try{
            cpu0CurFreq = RCommand.readFileContent(Constants.CPU7_CURR_FREQ);
    ...
    public static String getCpu0StatusContent(){
        ...
        try {
            String cpu0CurFreq = getCpu0CruFreq_CPU0();
